...
<body>
    <form id="form1" runat="server">
        ...
        <div> 
            ...
            <asp:SqlDataSource ID="grade_db" runat="server" ConnectionString="Provider=Microsoft.Jet.OLEDB.4.0;Data Source=|DataDirectory|\dvd0407.mdb" ProviderName="System.Data.OleDb" SelectCommand="SELECT [grade] FROM [videograde]"></asp:SqlDataSource>
            <br />
            ...
            <asp:SqlDataSource ID="type_db" runat="server" ConnectionString="Provider=Microsoft.Jet.OLEDB.4.0;Data Source=|DataDirectory|\dvd0407.mdb" ProviderName="System.Data.OleDb" SelectCommand="SELECT [type] FROM [videotype]"></asp:SqlDataSource>
            <br />
        </div>
        <div>
            <br />
